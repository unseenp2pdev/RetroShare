...
void RsControlModule::run()
{
    ...
    while(!login_ok)
    {
        ...
        case 0:
            ...
            break;
        case 1:
            error_string = "Another UnseenP2P using the same profile is "
                           "already running on your system. Please close "
                           "that instance first\n Lock file:\n" + lockFile;
            break;
        case 2:
            error_string = "An unexpected error occurred when UnseenP2P "
    ...
    std::cerr << "RsControlModule: login ok, starting UnseenP2P worker threads..." << std::endl;
    ...
    std::cerr << "RsControlModule: UnseenP2P is up and running. Enjoy!" << std::endl;
    ...
    std::cerr << "RsControlModule: stopping UnseenP2P..." << std::endl;
    RsControl::instance() -> rsGlobalShutDown();
    std::cerr << "RsControlModule: UnseenP2P stopped. Bye!" << std::endl;
}
...
void RsControlModule::handleIdentities(Request &, Response &resp)
{
    ...
    {
        resp.setFail("UnseenP2P is not initialised. Operation not possible.");
        return;
    }
