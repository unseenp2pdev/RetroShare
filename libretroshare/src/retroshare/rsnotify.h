...
const uint32_t RS_FEED_ITEM_CHATS_OFFLINE_NEW      = RS_FEED_TYPE_CHANNEL  | 0x0001;
const uint32_t RS_FEED_ITEM_CHATS_OFFLINE_MSG      = RS_FEED_TYPE_CHANNEL  | 0x0003;
const uint32_t RS_FEED_ITEM_CHATS_OFFLINE_PUBLISHKEY = RS_FEED_TYPE_CHANNEL  | 0x0004;
