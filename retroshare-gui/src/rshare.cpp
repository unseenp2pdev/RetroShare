...
/** Catches debugging messages from Qt and sends them to UnseenP2P's logs. If Qt
...
bool Rshare::loadCertificate(const RsPeerId &accountId, bool autoLogin)
{
	...
	switch (retVal) {
		...
		case 1:	QMessageBox::warning(	0,
                                        ...
                                        QObject::tr("Another UnseenP2P using the same profile is "
		...
		case 2:	QMessageBox::critical(	0,
										QObject::tr("Multiple instances"),
                                        QObject::tr("An unexpected error occurred when UnseenP2P "
