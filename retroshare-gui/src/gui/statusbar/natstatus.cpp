...
//    statusDHT->setMinimumSize( statusPeers->frameSize().width() + 0, 0 );
    ...
    iconLabel->setPixmap(QPixmap(":/app/images/statusicons/bad.png"));      //d: update icon
...
void NATStatus::getNATStatus()
{
	...
	switch(netState)
	{
		...
		{
            iconLabel->setPixmap(QPixmap(":/app/images/statusicons/bad.png").scaledToHeight(S,Qt::SmoothTransformation)) ;          //d: update icon
...
// BAD. (RED)
		...
		{
            iconLabel->setPixmap(QPixmap(":/app/images/statusicons/dnd.png").scaledToHeight(S,Qt::SmoothTransformation)) ;          //d: update icon
...
// GOOD (GREEN)
		...
		{
            iconLabel->setPixmap(QPixmap(":/app/images/statusicons/online.png").scaledToHeight(S,Qt::SmoothTransformation)) ;       //d: update icon
            iconLabel->setToolTip( text + tr("UnseenP2P Server")) ;
		}
		break ;
