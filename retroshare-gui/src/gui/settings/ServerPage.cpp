    ...
    : ConfigPage(parent, flags), mIsHiddenNode(false), mHiddenType(RS_HIDDEN_TYPE_NONE)
{
  ...
  if(RsAccounts::isTorAuto())
  {
    ...
    ui.hiddenpage_outHeader->setText(tr("Tor has been automatically configured by UnseenP2P. You shouldn't need to change anything here.")) ;
    ui.hiddenpage_inHeader->setText(tr("Tor has been automatically configured by UnseenP2P. You shouldn't need to change anything here.")) ;
  }
...
void ServerPage::updateStatusBob()
{
    ...
    bobSimpleText.append(tr("UnseenP2P uses BOB to set up a %1 tunnel at %2:%3 (named %4)\n\n"
