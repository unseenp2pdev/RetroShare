...
{
    return tr("<h1><img width=\"24\" src=\":/home/img/question-64.png\">&nbsp;&nbsp;Webinterface</h1>  \
     <p>The webinterface allows you to control UnseenP2P from the browser. Multiple devices can share control over one UnseenP2P instance. So you could start a conversation on a tablet computer and later use a desktop computer to continue it.</p>\
