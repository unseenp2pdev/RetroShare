...
#ifndef GXSCHATPOSTSWIDGET_H
#define GXSCHATPOSTSWIDGET_H
...
class GxsChatPostsWidget : public GxsMessageFramePostWidget, public FeedHolder
{
    Q_OBJECT
...
public:
    /** Default Constructor */
    GxsChatPostsWidget(const RsGxsGroupId &channelId, QWidget *parent = 0);
    /** Default Destructor */
    ~GxsChatPostsWidget();
...
private:
    ...
    void insertChannelPosts(std::vector<RsGxsChatMsg> &posts, GxsMessageFramePostThread *thread, bool related);
...
private:
    ...
    /* UI - from Designer */
    Ui::GxsChatPostsWidget *ui;
};


#endif // GXSCHATPOSTWIDGET_H
