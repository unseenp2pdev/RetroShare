...
#ifndef GXSCHATFILESWIDGET_H
#define GXSCHATFILESWIDGET_H
...
namespace Ui {
class GxsChatFilesWidget;
}

class GxsChatFilesWidget : public QWidget
{
    Q_OBJECT

public:
    explicit GxsChatFilesWidget(QWidget *parent = 0);
    ~GxsChatFilesWidget();

    void addFiles(const RsGxsChatMsg &post, bool related);
    void clear();
...
private:
    ...
    Ui::GxsChatFilesWidget *ui;
};


#endif // GXSCHATFILESWIDGET_H
