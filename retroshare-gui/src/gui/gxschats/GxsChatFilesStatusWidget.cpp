...
#include "ui_GxsChatFilesStatusWidget.h"
#include "gui/common/RsUrlHandler.h"

#include "retroshare/rsfiles.h"

GxsChatFilesStatusWidget::GxsChatFilesStatusWidget(const RsGxsGroupId &groupId, const RsGxsMessageId &messageId, const RsGxsFile &file, QWidget *parent) :
    QWidget(parent), mGroupId(groupId), mMessageId(messageId), mFile(file), ui(new Ui::GxsChatFilesStatusWidget)
{
    ui->setupUi(this);
...
GxsChatFilesStatusWidget::~GxsChatFilesStatusWidget()
{
    delete ui;
}

void GxsChatFilesStatusWidget::setSize(uint64_t size)
{
    mDivisor = 1;
...
void GxsChatFilesStatusWidget::check()
{
    FileInfo fileInfo;
...
void GxsChatFilesStatusWidget::download()
{
...
void GxsChatFilesStatusWidget::pause()
{
...
void GxsChatFilesStatusWidget::resume()
{
...
void GxsChatFilesStatusWidget::cancel()
{
...
void GxsChatFilesStatusWidget::openFolder()
{
    FileInfo fileInfo;
    if (!rsFiles->alreadyHaveFile(mFile.mHash, fileInfo)) {
        return;
