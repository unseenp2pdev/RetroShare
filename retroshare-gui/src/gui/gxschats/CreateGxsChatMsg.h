...
#ifndef CREATEGXSCHATMSG_H
#define CREATEGXSCHATMSG_H


#include "ui_CreateGxsChatMsg.h"
...
class CreateGxsChatMsg : public QDialog, public TokenResponse, private Ui::CreateGxsChatMsg
{
    Q_OBJECT

public:
    /** Default Constructor */
    CreateGxsChatMsg(const RsGxsGroupId& cId, RsGxsMessageId existing_post = RsGxsMessageId());
