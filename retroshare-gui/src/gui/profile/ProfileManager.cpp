...
void ProfileManager::exportIdentity()
{
    ...
    QString fname = QFileDialog::getSaveFileName(this, tr("Export Identity"), "", tr("UnseenP2P Identity files (*.asc)"));
...
void ProfileManager::importIdentity()
{
    ...
    if(!misc::getOpenFileName(this,RshareSettings::LASTDIR_CERT,tr("Import Identity"), tr("UnseenP2P Identity files (*.asc)"),fname))
            return ;
