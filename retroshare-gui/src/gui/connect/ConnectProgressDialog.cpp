...
void ConnectProgressDialog::sayInProgress()
{
	...
	message += "\n";
    message += tr("UnseenP2P will continue connecting in the background");
...
void ConnectProgressDialog::sayConnectTimeout()
{
	...
	message += "\n\n";
    message += tr("Try again shortly, UnseenP2P will continue connecting in the background");
	message += "\n\n";
...
void ConnectProgressDialog::sayDHTOffline()
{
    ...
    QString message = tr("The DHT is OFF, so UnseenP2P cannot find your Friends.");
	message += "\n\n";
    message += tr("UnseenP2P has tried All Known Addresses, with no success");
	message += "\n";
	message += tr("The DHT is needed if your friends have Dynamic IP Addresses.");
	message += "\n";
    message += tr("Only Advanced UnseenP2P users should switch off the DHT.");
	message += "\n\n";
...
void ConnectProgressDialog::sayDenied()
{
	...
	message += "\n\n";
    message += tr("Your UnseenP2P Node is configured Okay");
...
void ConnectProgressDialog::sayPeerNoDhtConfig()
{
    ...
    QString message = tr("Your Friend has configured UnseenP2P with DHT Disabled.");
	message += "\n\n";
	message += tr("You have previously connected to this Friend");
	message += "\n";
    message += tr("UnseenP2P has determined that they have DHT switched off");
	message += "\n";
    message += tr("Without the DHT it is hard for UnseenP2P to locate your friend");
	message += "\n\n";
...
void ConnectProgressDialog::sayInvalidPeer()
{
	...
	message += "\n\n";
    message += tr("UnseenP2P cannot connect without this information");
	message += "\n\n";
