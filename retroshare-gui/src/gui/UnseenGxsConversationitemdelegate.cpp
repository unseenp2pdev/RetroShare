...
#include "UnseenGxsConversationitemdelegate.h"
...
UnseenGxsConversationItemDelegate::UnseenGxsConversationItemDelegate(QObject* parent)
...
void
UnseenGxsConversationItemDelegate::paint(QPainter* painter
...
//        opt.state ^= QStyle::State_HasFocus;
    ...
    auto isContextMenuOpen = index.data(static_cast<int>(UnseenGxsSmartListModel::Role::ContextMenuOpen)).value<bool>();
    bool selected = false;
...
//    }
    ...
    if (auto messageCount = index.data(static_cast<int>(UnseenGxsSmartListModel::Role::UnreadMessagesCount)).toInt())
    {
    ...
    // Presence indicator
    QString statusStr =  index.data(static_cast<int>(UnseenGxsSmartListModel::Role::Presence)).value<QString>();
...
QSize
UnseenGxsConversationItemDelegate::sizeHint(const QStyleOptionViewItem& option,
...
void
UnseenGxsConversationItemDelegate::paintConversationItem(QPainter* painter,
                                                const QStyleOptionViewItem& option,
                                                const QRect& rect,
                                                const QModelIndex& index,
...
//    }
    ...
    QString nameStr = index.data(static_cast<int>(UnseenGxsSmartListModel::Role::DisplayName)).value<QString>();
    if (!nameStr.isNull()) {
    ...
    QString idStr = index.data(static_cast<int>(UnseenGxsSmartListModel::Role::DisplayID)).value<QString>();
...
//                    rect.height() / 2 - 2);
    ...
    QString interactionStr = index.data(static_cast<int>(UnseenGxsSmartListModel::Role::LastInteraction)).value<QString>();
